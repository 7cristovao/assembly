...
; converte e ir pro ponto correto
  mov ah, [opc]
  sub ah, "0"
...
; exercicio: implementar convert pra inteiro, (funcoes na aula 4) 
             ; int(opc 1) int(val1) int(val2) faz o somatorio, comandos add sub mul div